...
# Kelas untuk mengelola data di PostgreSQL
class Data(Base):
...
# Kelas untuk mengelola log di PostgreSQL dan MySQL
class Log(Base):
                    ...
                    if bef == 1:
                        ...
                        if "Testing" in data:  
                            try:
                                ...
                                # Kirim data ke PostgreSQL
                                Data.kirim_data_postgresql(session_postgresql, hardness, diameter, thickness, "N", "A20230626002", time_series=no)

                                # Kirim data ke MySQL
                                val = (thickness, diameter, hardness, "N", "A20230626002", time_series)
                                sql = """
