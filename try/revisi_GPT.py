...
def save_data_to_json(filename, new_data):
    """Save new data to JSON file without overwriting existing data."""
    try:
        # Load existing data from the JSON file
        with open(filename, "r") as infile:
            existing_data = json.load(infile)
    except FileNotFoundError:
        existing_data = []  # If file doesn't exist, create an empty list
                ...
                if line:
                    ...
                    if bef == 1:
                        ...
                        if "Testing" in data:
                            ...
                            save_data_to_json("testobat.json", new_data)
...
if __name__ == "__main__":
    ...
    while True:
        # Just keep the program running for continuous reading
        time.sleep(1)
